/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5129e2191fcbcb3a7752d43943d4bba8)
// Runtime types generated with workerd@1.20260212.0 2025-11-06 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		GROQ_SAFEGUARD_MODEL: "openai/gpt-oss-20b";
		CREATOR_ID: "U09EFB5G6TS";
		ALLOWED_CHANNELS: "C09REGCDEA2,C0A21M6CWLU,C0ABQJZ5C3Z,C0ACEDARMM3";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GROQ_MODEL" | "GROQ_VISION_MODEL" | "GROQ_SAFEGUARD_MODEL" | "CREATOR_ID" | "ALLOWED_CHANNELS" | "SLACK_SIGNING_SECRET" | "SLACK_BOT_TOKEN" | "EXASEARCH_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
